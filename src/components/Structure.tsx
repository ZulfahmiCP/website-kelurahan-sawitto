import { struktur } from '../data/content';
        ...
        <div className="flex flex-col items-center max-w-5xl mx-auto">
          <div className="flex flex-col items-center">
            <div className="bg-primary-50 border border-primary-200 rounded-2xl p-6 md:p-8 text-center w-72 md:w-80 shadow-sm relative z-10">
              <h4 className="text-xl md:text-2xl font-black text-slate-900">{struktur.lurah.nama}</h4>
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary-600 mt-2">{struktur.lurah.jabatan}</p>
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="bg-white border border-primary-100 rounded-2xl p-6 md:p-8 text-center w-72 md:w-80 shadow-sm relative z-10">
              <h4 className="text-lg md:text-xl font-bold text-slate-800">{struktur.seklur.nama}</h4>
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary-500 mt-2">{struktur.seklur.jabatan}</p>
            </div>
            <div className="w-px h-10 bg-primary-300"></div>
          </div>
